      ...
      <section id='sec2'>
        <div className='container'>
          <div className='section-title'>
            ...
            <p>
              Explore some of the best meetups from around the city created and
          ...
          <div className='time-line-wrap fl-wrap'>
            <div className='time-line-container'>
              ...
              <div className='time-line-box tl-text tl-left'>
                ...
                <h3>Sign Up</h3>
                <p>
                  Joining my space dev will allow you to meet influential
                  developers in the area and attend relevant meetups that relate
                  to you.
                </p>
              </div>
            ...
            <div className='time-line-container lf-im'>
              ...
              <div className='time-line-box tl-text tl-right'>
                ...
                <p>
                  Tell us about yourself to allow us to better match meetups and
                  developers with similiar shared skills.
                </p>
              </div>
            ...
            <div className='time-line-container'>
              ...
              <div className='time-line-box tl-text tl-left'>
                ...
                <p>
                  Our recommendation enginae will use the content you supply to
                  us alongside our own unsupervised machine learning to help
                  guide you towards relevant interests.
                </p>
              </div>
              <div className='time-line-box tl-media tl-right'>
                <img src='images/all/1.jpg' alt='' />
