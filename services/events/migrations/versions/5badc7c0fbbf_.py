...
Revision ID: 5badc7c0fbbf
Revises: 
Create Date: 2018-07-16 21:57:10.971982
...
def upgrade():
    ...
    sa.Column('name', sa.String(length=128), nullable=False),
    sa.Column('description', sa.String(length=1000), nullable=False),
    sa.Column('abbreviations', postgresql.ARRAY(sa.String()), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('channel_topic_association',
    sa.Column('channel_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('topic_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['channel_id'], ['channel.id'], ),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], )
    )
    op.create_table('event_entry_association',
    ...
    op.create_table('event_topic_association',
    sa.Column('event_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('topic_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['event.id'], ),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], )
    )
    op.create_table('meetup_event_association',
    sa.Column('meetup_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('event_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['event.id'], ),
    sa.ForeignKeyConstraint(['meetup_id'], ['meetup.id'], )
    )
    op.create_table('speaker_diversity_association',
    ...
    op.create_table('speaker_topic_association',
    sa.Column('speaker_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.Column('topic_id', postgresql.UUID(as_uuid=True), nullable=True),
    sa.ForeignKeyConstraint(['speaker_id'], ['speaker.id'], ),
    sa.ForeignKeyConstraint(['topic_id'], ['topic.id'], )
